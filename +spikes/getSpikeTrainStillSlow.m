function [timeAxis, times_spiking, spikeCountMatrix, spikeRateMatrix, areaPerNeuron] = getSpikeTrainStillSlow(animal, timebinSize, samplingRate)
...
%     animal = append(extractBetween(filename, 1, 4),"cellinfo.mat");
    ...
    if nargin == 3 %RY added new option for sampling rate + window size, copy-pasting some of your code and modifying
